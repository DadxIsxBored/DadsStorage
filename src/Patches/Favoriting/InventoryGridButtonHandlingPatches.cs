...
internal class InventoryGridButtonHandlingPatches
{
    ...
    internal static bool OnLeftDown(InventoryGrid __instance, UIInputHandler clickHandler)
    {
    ...
    private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
    {
        ...
        {
            DadsStoragePlugin.DadsStorageLogger.LogError($"There was an exception while transpiling {e}\n{e.StackTrace}");
            return instructions;
        }
    }*/
    ...
    internal static bool HandleClick(InventoryGrid __instance, Vector2i buttonPos, bool isLeftClick, bool searchBypass = false)
    {
        ...
        switch (isLeftClick)
        {
            ...
            case true when searchBypass:
            {
                ...
                Chat.instance.TryRunCommand($"dadsstoragesearch {itemAt.m_dropPrefab.name.ToLower()}", false, true);
                break;
            }
            default:
            {
