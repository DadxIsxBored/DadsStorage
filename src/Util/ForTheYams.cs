...
public static class YamlUtils
{
    internal static void ReadYaml(string yamlInput)
    {
        ...
        DadsStorageLogger.LogDebug($"yamlData:\n{yamlInput}");
    }
    ...
    internal static void ParseGroups()
    {
        ...
        if (yamlData.TryGetValue("groups", out object groupData))
        {
            ...
            {
                DadsStorageLogger.LogError("groupData is not of type Dictionary<object, object>.");
            }
        }
        else
        {
            DadsStorageLogger.LogError("No 'groups' key found in yamlData.");
        }
    }
